...
def astraahome():
    ...
    print(f"""{Fore.LIGHTWHITE_EX }ev.club/ {Fore.LIGHTBLUE_EX }|{Fore.LIGHTWHITE_EX } http://astraadev.club/ {Fore.LIGHTBLUE_EX }|{Fore.LIGHTWHITE_EX } http://socialbot404.cf/ {Fore.LIGHTBLUE_EX }|{Fore.LIGHTWHITE_EX } http://astraadev.club/ {Fore.LIGHTBLUE_EX }|{Fore.LIGHTWHITE_EX } http://socialbot404.cf/ {Fore.LIGHTBLUE_EX }|{Fore.LIGHTWHITE_EX } http://as""")
    print(f"""{Fore.LIGHTYELLOW_EX }------------------------------------------------------------------------------------------------------------------------\n""")
...
def main():
    ...
    if choice == '1' or choice == '01':
        ...
        print(f"""                                                {Fore.LIGHTYELLOW_EX }[{Fore.LIGHTWHITE_EX }#{Fore.LIGHTYELLOW_EX }]{Fore.LIGHTWHITE_EX } GitHub:    https://github.com/social404""")
        print(f"""                                                {Fore.LIGHTYELLOW_EX }[{Fore.LIGHTWHITE_EX }#{Fore.LIGHTYELLOW_EX }]{Fore.LIGHTWHITE_EX } YouTube:   https://www.youtube.com/channel/UCXk0klxbjcVgGvYyKWLgtLg/""")
        print(f"""                                                {Fore.LIGHTYELLOW_EX }[{Fore.LIGHTWHITE_EX }#{Fore.LIGHTYELLOW_EX }]{Fore.LIGHTWHITE_EX } Server:    https://discord.gg/UzTqHJQPSs\n\n""")
        print(f"""                                            {Fore.LIGHTYELLOW_EX }[{Fore.LIGHTBLUE_EX }+{Fore.LIGHTYELLOW_EX }]{Fore.LIGHTWHITE_EX } Astraa's Networks:\n""")
